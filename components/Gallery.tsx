    ...
    <section id="gallery" className="py-24 px-6 overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 scroll-reveal">
          <div>
            <h2 className="text-6xl md:text-8xl font-serif font-extrabold text-stone-950 mb-6 italic tracking-normal uppercase">Visual Story</h2>
            <p className="text-stone-800 tracking-[0.4em] uppercase text-xs font-semibold">Capturing the spiral aesthetic</p>
          </div>
          <div className="hidden md:block">
            <span className="text-stone-100 text-[10rem] font-serif font-extrabold select-none pointer-events-none leading-none">SPIRAL</span>
          </div>
        </div>
        ...
        <div className="mt-24 text-center scroll-reveal">
           <a 
             ...
             className="inline-block text-sm font-semibold uppercase tracking-[0.4em] text-stone-950 hover:text-amber-900 transition-colors border-b-2 border-stone-300 pb-3"
           >
