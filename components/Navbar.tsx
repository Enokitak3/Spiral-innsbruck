  ...
  return (
    <>
      ...
      <nav 
        ...
        className={`fixed w-full z-50 bg-white border-b border-stone-200 transition-transform duration-500 ease-in-out shadow-sm ${
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          >
            ...
            <span className="text-xl font-extrabold tracking-tight text-stone-900 uppercase">Spiral</span>
          </button>
          ...
          <div className="hidden lg:flex gap-10 text-[13px] font-bold uppercase tracking-[0.1em] text-stone-700">
            {['about', 'menu', 'gallery', 'contact'].map((id) => (
              <button 
                key={id}
                onClick={() => scrollTo(id)} 
                className="hover:text-stone-950 transition-colors relative group"
              >
          ...
          <div className="flex gap-4 items-center">
            <a href="https://www.google.com/maps/dir/?api=1&destination=Andreas-Hofer-Straße+7+6020+Innsbruck+Austria" 
               ...
               className="hidden sm:flex items-center gap-3 bg-stone-950 text-white px-6 py-3 rounded-full text-[11px] font-bold tracking-widest hover:bg-stone-800 transition-all shadow-md">
              <MapPin size={12} />
              DIRECTIONS
            </a>
            <button 
      ...
      <div 
        ...
        className={`fixed inset-0 z-[45] bg-stone-950 flex flex-col items-center justify-center lg:hidden ${isMobileMenuOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}
        ...
        <div className="flex flex-col gap-10 text-center">
          {['about', 'menu', 'gallery', 'contact'].map((id) => (
            <button 
              ...
              onClick={() => scrollTo(id)}
              className="text-4xl font-display font-bold italic text-white hover:text-amber-400 transition-colors capitalize"
            >
